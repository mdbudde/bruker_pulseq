# -------------------------------------------------------------
# /pvVersions/linux_intel/Pv601/prog/parx/src/pulseqV1/Makefile
# 
...
SEQ_DIR	 = $(EXECDISKUNIT)/prog/curdir/$(USER)/ParaVision/exp/lists/seq
...
SRCDIR		= $(EXECDISKUNIT)/prog/curdir/$(USER)/ParaVision/methods/src/pulseqV1
...
CPPRELOBJS = pulseq_wrapper$(OBJEXT) ExternalSequence$(OBJEXT) md5$(OBJEXT)
...
$(CPPRELOBJS):
	@$(ECHO) Compile $(SRCDIR)/$(@:$(OBJEXT)=.cpp)
	$(CPLUSPLUS) -c $(SRCDIR)/$(@:%.o=%.cpp) -o $@ $(CPLUSPLUSFLAGS)

	
$(OVERLAY)$(PARX_OVL_EXT): $(OBJS) $(CPPRELOBJS) $(PARX_OVL_LIBS)
	@$(ECHO) Link $(OVERLAY)$(PARX_OVL_EXT)
	$(RM) $(OVERLAY)$(PARX_OVL_EXT)
	$(PARX_OVL_LD) -shared -Wl,-no-undefined,-soname,$(OVERLAY)$(PARX_OVL_EXT) \
	   $(CPLUSPLUSLDOPTIONS) $(OBJS) $(CPPRELOBJS) \
	   $(PARX_OVL_LIBPATH)  $(PARX_OVL_LIBS) \
	   $(PARX_OVL_LIBRARIES) -o $(OVERLAY)$(PARX_OVL_EXT)

DEP_SRCS += $(SRCS) $(CPPRELSRCS)
DEP_LINES += " "
depend::
	$(RM) Makefile.bak
...
install :: 
	if [ ! -d $(SEQ_DIR) ]; then $(MKDIR) $(SEQ_DIR) ; fi
	@if [ -f $(SRCDIR)/gre.seq ]; then \
	   $(ECHO) Install $(SEQ_DIR)/greseq; \
	   $(RM) $(SEQ_DIR)/greseq ; \
	   $(CPASC) $(SRCDIR)/gre.seq $(SEQ_DIR)/greseq; \
	fi
...
pulseqV1.o: \
 /opt/PV6.0.1/prog/curdir/budde/ParaVision/methods/src/pulseqV1/pulseqV1.c \
 ...
 /opt/PV6.0.1/prog/curdir/budde/ParaVision/methods/src/pulseqV1/parsDefinition.h \
 /opt/PV6.0.1/prog/curdir/budde/ParaVision/methods/src/pulseqV1/pulseqPars.h \
 /opt/PV6.0.1/prog/curdir/budde/ParaVision/methods/src/pulseqV1/pulseqTypes.h \
 /opt/PV6.0.1/prog/curdir/budde/ParaVision/methods/src/pulseqV1/callbackDefs.h \
 ...
 /opt/PV6.0.1/prog/curdir/budde/ParaVision/methods/src/pulseqV1/parsLayout.h
initMeth.o: \
 /opt/PV6.0.1/prog/curdir/budde/ParaVision/methods/src/pulseqV1/initMeth.c \
 /opt/PV6.0.1/prog/curdir/budde/ParaVision/methods/src/pulseqV1/method.h \
...
pulseqRelations.o: \
 ...
 /opt/PV6.0.1/prog/curdir/budde/ParaVision/methods/src/pulseqV1/relProtos_p.h \
 /opt/PV6.0.1/prog/curdir/budde/ParaVision/methods/src/pulseqV1/pulseqTypes.h \
 /opt/PV6.0.1/prog/curdir/budde/ParaVision/methods/src/pulseqV1/pulseq_wrapper.h
pulseq_wrapper.o: \
 /opt/PV6.0.1/prog/curdir/budde/ParaVision/methods/src/pulseqV1/pulseq_wrapper.cpp \
 /opt/PV6.0.1/prog/curdir/budde/ParaVision/methods/src/pulseqV1/ExternalSequence.h
ExternalSequence.o: \
 /opt/PV6.0.1/prog/curdir/budde/ParaVision/methods/src/pulseqV1/ExternalSequence.cpp \
 /opt/PV6.0.1/prog/curdir/budde/ParaVision/methods/src/pulseqV1/ExternalSequence.h \
 /opt/PV6.0.1/prog/curdir/budde/ParaVision/methods/src/pulseqV1/md5.h
md5.o: \
 /opt/PV6.0.1/prog/curdir/budde/ParaVision/methods/src/pulseqV1/md5.cpp \
 /opt/PV6.0.1/prog/curdir/budde/ParaVision/methods/src/pulseqV1/md5.h
